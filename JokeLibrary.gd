...
func _ready():
	...
	JokeArr.append({ "text": "I watched my father die when I 6. It's a painful memory that I blocked out for 12 years before finally confronting this tragic moment with the support of my court-appointed therapist after I was charged with aggravated assault.", "Success": "Strange, Honest, and somewhat charming. I appreciate your sharing this with me. Thankyou.", "VERBOSITY": Enums.intensity.HIGH, "ABSURDISM": Enums.intensity.LOW, "WORDPLAY": Enums.intensity.LOW })
	...
	JokeArr.append({ "text": "How woodlice look at you when you turn over a rock: 0_0 0_0 0_0", "Success": "A left-field use of font text make this a surprising joke! Well done!", "VERBOSITY": Enums.intensity.MEDIUM, "ABSURDISM": Enums.intensity.HIGH, "WORDPLAY": Enums.intensity.LOW })
	...
	JokeArr.append({ "text": "How do Minecraft players avoid getting sunburn? They use sun block!","Success": "Minecraft? That must be some block associated game. Therefore, Sun Block must be a good pun!", "VERBOSITY": Enums.intensity.MEDIUM, "ABSURDISM": Enums.intensity.LOW, "WORDPLAY": Enums.intensity.MEDIUM })
	JokeArr.append({ "text": "What's a skeleton's favourite instrument? The xylo-bone!", "Success": "While I do not possess a skeleton, I can still appreciate the play on words here. Very good!", "VERBOSITY": Enums.intensity.MEDIUM, "ABSURDISM": Enums.intensity.MEDIUM, "WORDPLAY": Enums.intensity.HIGH })
	...
	JokeArr.append({ "text": "Did you hear about the drag queen working in the local restaurant? She served!", "Success": "Oh yes, I am familiar with common Drag Queen slang, an excellent pun!", "VERBOSITY": Enums.intensity.MEDIUM, "ABSURDISM": Enums.intensity.MEDIUM, "WORDPLAY": Enums.intensity.HIGH })
